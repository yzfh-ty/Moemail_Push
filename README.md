...
一个部署在 **Cloudflare Workers** 上的轻量级服务，用于将 MoeMail [<sup>4</sup>](https://moemail.app/) 的新邮件 Webhook 转发为**企业微信机器人**通知，并提供了一个兼容 **Bitwarden (Addy.io)** 的邮箱别名创建接口。
...
本仓库的代码及文档遵循 知识共享 署名 4.0 国际 (CC BY 4.0) 许可协议 [<sup>6</sup>](https://creativecommons.org/licenses/by/4.0/) 进行许可。
